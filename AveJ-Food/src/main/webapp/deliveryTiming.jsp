...
<body>
    ...
    <section class="restaurants" style="background-color: rgb(255, 253, 253)">
        <div class="restaurant-container">
            ...
            List<Restaurant> restaurantTiming = (List<Restaurant>) session.getAttribute("restaurantTiming");
            System.out.println(restaurantTiming);

            if (restaurantTiming != null) {
                for (Restaurant restaurant : restaurantTiming) {
            %>
