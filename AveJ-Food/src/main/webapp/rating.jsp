...
<body>
	...
	<header class="header">
		<nav>
			...
			<ul>
				...
				<li><a href="ViewCart" id="cart-button" class="cart"> <i
 ...
 %>
	...
	<div class="search-container">
        <form action="cuisineType" method="post">
	...
	<section class="restaurants"
		...
		<div class="restaurant-container">
			...
			List<Restaurant> restaurantRating = (List<Restaurant>) session.getAttribute("restaurantRating");
			System.out.println(restaurantRating);

			if (restaurantRating != null) {
				for (Restaurant restaurant : restaurantRating) {
			%>
